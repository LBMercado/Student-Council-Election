    ...
    def newConnection(self, dbName):
        ...
        with self.dbConnection:
            ...
            if returnedRow is not None:
                ...
                self.dbServer.executemany('INTO user_info VALUES(?,?,?,?,?,?,?)', to_db)
...
#eto write
    def WriteVote(self, userID, president, internal_vp, external_vp, second_yr, third_yr, fourth_yr, business, csc, executive_secretary, general_engineering, amusement, audit, finance, information, logistics, scholarship, welfare):   
        with self.dbConnection:
            self.dbServer.execute("""INSERT INTO vote_ticket (user_id,vote_president, 
                                                       vote_internal_vp, 
                                                       vote_external_vp, 
                                                       vote_2nd_yr, 
                                                       vote_3rd_yr, 
                                                       vote_4th_yr, 
                                                       vote_business_manager, 
                                                       vote_csc, 
                                                       vote_executive_secretary, 
                                                       vote_general_engineering, 
                                                       vote_secretary_of_amusement,  
                                                       vote_secretary_of_audit, 
                                                       vote_secretary_of_finance,  
                                                       vote_secretary_of_information, 
                                                       vote_secretary_of_logistics, 
                                                       vote_secretary_of_scholarship,
                                                       vote_secretary_of_welfare) 
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)""" ,  (userID, president, internal_vp, external_vp, second_yr, third_yr, fourth_yr, business, csc, executive_secretary, general_engineering, amusement, audit, finance, information, logistics, scholarship, welfare,))
